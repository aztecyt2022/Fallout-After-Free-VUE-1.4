...
function binloader_init() {
  ...
  var USB_PAYLOAD_PATHS = ['/mnt/usb0/payload.bin', '/mnt/usb1/payload.bin', '/mnt/usb2/payload.bin', '/mnt/usb3/payload.bin', '/mnt/usb4/payload.bin'];
